...
//             {/*    <h1 id="selectedTagDisplay">Selected Tag: </h1>*/}
//             {/*</div>*/}
//         </div>
//
//     );
...
export default function Seach() {
    ...
    const tags = useQuery(['tags', filterOption], async () => {
                                                    ...
                                                    <h3 className="-mx-2 -my-3 flow-root">
                                                        <Disclosure.Button
                                                            className="flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500">
                                                                    <span
                                                                        className="font-medium text-gray-900">Tags</span>
                                      ...
                                      <PlusIcon className="h-5 w-5" aria-hidden="true"/>
                                                    ...
                                                    <Disclosure.Panel className="pt-6">
                                                        <div className="space-y-6">
                                                            {tags.data && tags.data.map((option, optionIdx) => (
                                                                <div key={option.name}
                    ...
                    <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form className="hidden lg:block">
                                ...
                                <Disclosure as="div" key="tags" className="border-b border-gray-200 py-6">
                                    {({open}) => (
                                        <>
                                  ...
                                  <PlusIcon className="h-5 w-5" aria-hidden="true"/>
                                            ...
                                            <Disclosure.Panel className="pt-6">
                                                <div className="space-y-4">
                                                    {tags.data && tags.data.map((option) => (
